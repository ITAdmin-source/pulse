...
export function StatementCard({
  ...
  return (
    <div className="relative flex flex-col items-center w-full max-w-xs mx-auto" data-debug="statement-card-wrapper">
      {/* Statement Card - Content only (no overlaying buttons) */}
      <motion.div
        className="relative w-full group z-10 mb-4"
        data-debug="statement-card"
        initial={{
      ...
      >
        ...
        <Card className="relative w-full aspect-[2/3] max-h-[60vh] md:max-h-[60vh] shadow-lg rounded-3xl border-0 bg-gradient-to-br from-amber-50 via-orange-50/40 to-amber-50">
          <CardContent className="p-6 h-full flex flex-col justify-center items-center relative">
            ...
            {/* Overlaid Primary Voting Buttons - Inside Card */}
            <AnimatePresence mode="wait">
              {!showResults && buttonsVisible && (
                ...
                >
                  ...
                  <div className="absolute inset-0 -z-10 bg-gradient-to-t from-black/15 via-black/8 to-transparent rounded-2xl blur-sm" />
                  ...
                  <div className="flex gap-3 w-full">
                    ...
                    >
                      <Button
                        ...
                        disabled={disabled}
                        className="w-full h-12 text-sm font-bold shadow-lg hover:shadow-xl transition-all bg-gradient-to-b from-emerald-600 to-emerald-700"
                      >
                        {agreeLabel}
                      </Button>
                    </motion.div>
                    ...
                    >
                      <Button
                        onClick={() => handleVote(-1)}
                        disabled={disabled}
                        className="w-full h-12 text-sm font-bold shadow-lg hover:shadow-xl transition-all"
                        variant="destructive"
                      >
                        {disagreeLabel}
                      </Button>
              ...
              {/* Results Display - Overlaid on Card */}
              {showResults && (
                <motion.div
                  key="results-overlay"
                  className="absolute bottom-4 left-4 right-4 z-20"
                ...
                >
                  <div className="space-y-2 w-full">
                    ...
                    <div className="flex h-12 w-full rounded-full overflow-hidden shadow-lg border-2 border-white/80">
                      {/* Keep segment (Green) */}
                      <motion.div
      ...
      {/* Secondary actions row - Skip and Add Card (below card) */}
      <div className="flex items-center justify-center gap-3 mt-2" data-debug="secondary-buttons">
        {/* Skip/Pass button */}
        <Button
